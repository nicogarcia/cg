...
namespace Utilities.Shapes
{
    public class HelixObjLoader
    {
        ...
        /// </summary>
        private IList<Vector4> Normals { get; set; }

        /// <summary>
        /// Gets or sets the points.
        /// </summary>
        private IList<Vector4> Points { get; set; }
            ...
            using (this.Reader = new StreamReader(s))
            {
                ...
                while (!this.Reader.EndOfStream)
                {
                    ...
                    switch (keyword.ToLower())
                    {
                        ...
                        case "surf": // surface
                            // not supported
                            Console.WriteLine("Keyword " + keyword.ToLower() + " not supported");
                            break;
